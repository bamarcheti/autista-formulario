...
interface ResponsibleSectionProps {
  ...
  prefix: string;
  onFieldChange: (field: keyof ResponsibleData, value: string) => void;
  onFieldBlur: (field: keyof ResponsibleData) => void;
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <select
            ...
            className={getSelectClassName(getFieldState(fieldKey("parentesco")))}
          >
          ...
          {getError(fieldKey("parentesco")) && (
            <p className={errorClassName}>{getError(fieldKey("parentesco"))}</p>
          )}
        </div>
        ...
        <div>
          <label className={labelClassName}>
            Nome Completo do Responsável<span className="text-destructive ml-1">*</span>
          </label>
          <input
            type="text"
            value={data.nome}
