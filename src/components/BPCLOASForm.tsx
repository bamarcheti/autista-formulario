          ...
          <ResponsibleSection
            ...
            description={
              beneficiaryAge !== null && beneficiaryAge < 13
                ? tipoBeneficiario === "proprio"
                  ? "Como você é menor de 13 anos, precisamos dos dados do seu responsável legal."
                  : "Como o beneficiário é menor de 13 anos, precisamos dos dados do responsável legal."
